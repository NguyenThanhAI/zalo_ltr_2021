...
if __name__ == '__main__':
    ...
    print("Training round {}".format(args.round))
    
    model = CrossEncoder(model_name=args.pretrained_model,
                         num_labels=1,
    ...
    for idx, pair in enumerate(save_pairs):
        ...
        if idx <= num_train:
            ...
            sentence_pairs.append([question, document])
    ...
    evaluator = CEBinaryClassificationEvaluator(sentence_pairs=sentence_pairs, labels=scores)
